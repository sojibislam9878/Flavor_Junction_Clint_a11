    ...
    return (
        <div className="lg:flex justify-between container mx-auto p-4 mt-8 lg:mt-36 md:mt-28 gap-10">
            ...
            <div className="flex-1 mt-14 lg:mt-0 h-full">
                ...
                <p className="leading-7 opacity-80 mt-6">In the heart of our culinary community lies a passion for food that transcends borders and unites enthusiasts from every corner of the globe. At Flavor Junction, we are more than just a platform we are a vibrant hub where food lovers come together to celebrate their shared love for gastronomy.</p>
                <div className="mt-8">
                    <div>
