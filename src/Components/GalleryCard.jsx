    ...
    <div className="card card-compact bg-base-200 shadow-xl h-full overflow-hidden group">
      <div className="">
        <figure className="relativ overflow-hidden">
          ...
          />
          <div className="absolute h-1/5 w-full flex items-center justify-center bottom-10 group-hover:bottom-16 opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
